  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="components-orders" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="/<?php echo home . route('allOrdersCreateManually'); ?>">
            <i class="bi bi-circle"></i><span>Create Manually</span>
          </a>
        </li>
        <li>
          <a href="/<?php echo home . route('allOrdersAssignedList', ['is_assigned' => '0']); ?>">
            <i class="bi bi-circle"></i><span>New Uploaded</span>
          </a>
        </li>
        <li>
          <a href="/<?php echo home . route('allOrdersAssignedList', ['is_assigned' => 1]); ?>">
            <i class="bi bi-circle"></i><span>Just Assigned</span>
          </a>
        </li>
        <li>
